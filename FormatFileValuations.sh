...
echo "fact_validation_id|valuation_desc|day_desc|validation_building_excel|currency_cd|asset_reciclyn_program|Reversionary_Terminal_Cap_Rate|Capex_US_Sqft_yr|Discount_Rate|Cap_Rate|IRR|Going_In_Cap_Rate|NOI_Budget_USD|NOI_Budget_MXN|NOI_1_year_USD|NOI_1_year_MXN|Leasing_Managers_Rent|DCF_USD|DCF_MXN|YR_1_NOI_STABILIZED_USD|YR_1_NOI_STABILIZED_MXN|Market_Rent_APP|Comparison_Approach_USD|Comparison_Approach_MXN|Final_Val_USD|Final_Val_MXN|" > header.txt
...
cat header.txt tempo7 > valuations_file_out.txt
